	        	  ...
	        	  if(response.data.statecode==1){
						...
						var o_id = orderBean.o_id;
	  					...
	  					var ordertime = orderBean.o_ordertime; 
	  					 ...
	  					 window.location.href="cart-2.html?o_id="+o_id+"&phone="+phone+"&phone2="+phone2+"&totalPrice="+totalPrice+"&intime="+intime+"&outtime="+outtime+"&ordertime="+ordertime+"&num="+vm.num+"&roomType="+vm.rt_name;  
	        	  }
